...
{
    static_assert(std::is_object_v< T >, "A span's element type `T` must be an object type (not a reference type or void)");
    ...
    static_assert(!std::is_abstract_v< T >, "A span's element type `T` cannot be an abstract class type");
